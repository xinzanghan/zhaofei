...
Page({
  ...
  toHighStudentInfo(e) {
    ...
    if (that.data.idcard == '') {
      ...
      */
    //   let that = this;
    //   let idcard = this.data.idcard //idNum 为你输入的身份证  
    //   console.log(idcard)
    ...
    //       // console.log(r.data.student_token)
    //       this.setData({
    ...
    //       wx.redirectTo({
    //         url: '/pages/HighStudentIndex/index?idcard=' + idcard,
    //       })
    //     }, 800);
    //   }else{
    //     wx.showToast({
